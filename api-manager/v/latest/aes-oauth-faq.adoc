...
Using one of the following identity providers (IdP) as an OAuth provider is recommended:
...
The following diagram shows the request, the grant, and the delivery of credentials to a developer who wants to access your API:

image:external-identity-b0a95.png[1 Request API access, 2 Grant API client access, 3 Receive client credentials, 4 Developer app uses client credentials to call API]

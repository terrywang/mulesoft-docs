...
[NOTE]
For API Manager installations in Anypoint Private Cloud Edition, this command requires read/write access to the `/tmp` directory in your on-premises server
...
[NOTE]
This command requires read/write access to the `/tmp` directory in your on-premises server
